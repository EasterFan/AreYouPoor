...
public class Constants {
    public final static String VERY_GOOD_EMERGENCY_STATUS = "非常优秀的应急能力！";
    public final static String GOOD_EMERGENCY_STATUS = "优秀的应急能力！";
    public final static String DANGEROUS_EMERGENCY_STATUS = "比较危险的应急能力！";
